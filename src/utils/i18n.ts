export const translations = {
    'pt-BR': {
        ...
        actions: { start: 'Registrar Entrada', pause: 'Iniciar Pausa', resume: 'Voltar ao Trabalho', exit: 'Encerrar Expediente', openPanel: 'Abrir Painel de Jornada', closePanel: 'Fechar Painel', setPassword: 'Criar Senha de Acesso Web' },
        ...
        password: { title: 'Acesso pelo Celular', subtitle: 'Crie uma senha para acessar seu ponto fora do sistema da empresa.', newPassword: 'Nova Senha', save: 'Salvar Senha', cancel: 'Cancelar', success: 'Senha configurada com sucesso!', error: 'Erro ao salvar a senha.' }
    },
    en: {
        title: 'AP101 Tracker',
        ...
        actions: { start: 'Clock In', pause: 'Start Break', resume: 'Resume Work', exit: 'Clock Out', openPanel: 'Open Journey Panel', closePanel: 'Close Panel', setPassword: 'Create Web Password' },
        ...
        password: { title: 'Mobile Access', subtitle: 'Create a password to access your timesheet outside the company system.', newPassword: 'New Password', save: 'Save Password', cancel: 'Cancel', success: 'Password configured successfully!', error: 'Error saving password.' }
    }
}